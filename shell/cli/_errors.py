...
Every failure inside shell-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`shell.cli._output`,
...
# Exit-code policy. Documented in ``shell-cli learn`` output.
# 0      = success
